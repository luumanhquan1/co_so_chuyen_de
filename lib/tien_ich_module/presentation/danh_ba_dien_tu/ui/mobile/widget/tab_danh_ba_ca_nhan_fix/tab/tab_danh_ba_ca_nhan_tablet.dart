...
class DanhBaCaNhanFixTablet extends StatefulWidget {
  const DanhBaCaNhanFixTablet({Key? key}) : super(key: key);

  @override
  _DanhBaCaNhanFixTabletState createState() => _DanhBaCaNhanFixTabletState();
}

class _DanhBaCaNhanFixTabletState extends State<DanhBaCaNhanFixTablet> {
