      ...
      body: ScrollBarWidget(
        children: [
          ...
          Container(
            ...
            child: StreamBuilder<TodoListModel>(
                    ...
                    title: Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: titleText(color: infoColor, fontSize: 14),
                        ),
                        SvgPicture.asset(ImageAssets.icBacham)
                      ],
                    ),
                    subtitle: Row(
                      children: [
                        Text(
                          '${DateTime.parse(data.first.createdOn ?? DateTime.now().toString()).toStringWithListFormat} - ${DateTime.parse(data.last.createdOn ?? DateTime.now().toString()).toStringWithListFormat}',
                        ...
                        GestureDetector(
                          ...
                          child: Text(
                            S.current.chon_ngay,
                            style:
                                titleText(color: dangXyLyColor, fontSize: 14),
                          ),
                        ),
                      ],
                    ),
