...
class _DropdownButtonState<T> extends State<DropdownButtonWidget<T>> with WidgetsBindingObserver {
  int? _selectedIndex;
  ...
  void _updateSelectedIndex() {
    if (widget.items == null
        ...
        || (widget.value == null &&
            widget.items!
                .where((DropdownMenuItemWidget<T> item) => item.enabled && item.value == widget.value)
                .isEmpty)) {
      _selectedIndex = null;
      return;
    }
