      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: widget.borderColor ?? (_focusNode.hasFocus
                    ? AppColors.primary
                    : AppColors.greyF0FF),
                width: 1.0),
          ),
          child: TextField(
            ...
            style: widget.textStyle ??
                ThemeText.body5.copyWith(color: AppColors.grey),
            ...
            decoration: InputDecoration(
              ...
              labelStyle: ThemeText.body6.copyWith(color: AppColors.grey),
              hintText: widget.hintText,
              hintStyle: ThemeText.body6.copyWith(
                color: AppColors.grey,
              ),
              helperText: widget.helpText,
              contentPadding: EdgeInsets.symmetric(
                  horizontal: AppDimens.width_16,
                  vertical: AppDimens.height_13),
