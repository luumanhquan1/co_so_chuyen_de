...
class LichDuocMoiTabletScreen extends StatefulWidget {
  final CalenderCubit cubit;
  final bool isHindText;

  const LichDuocMoiTabletScreen({
    Key? key,
    required this.cubit,
  ...
  @override
  State<LichDuocMoiTabletScreen> createState() =>
      _LichDuocMoiTabletScreenState();
}

class _LichDuocMoiTabletScreenState extends State<LichDuocMoiTabletScreen> {
  @override
  void initState() {
    super.initState();
