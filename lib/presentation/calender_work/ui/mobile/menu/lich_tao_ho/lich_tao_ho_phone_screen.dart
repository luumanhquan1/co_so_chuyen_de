...
class LichTaoHoPhoneScreen extends StatefulWidget {
  final CalenderCubit cubit;

  const LichTaoHoPhoneScreen({Key? key, required this.cubit}) : super(key: key);

  @override
  State<LichTaoHoPhoneScreen> createState() => _LichTaoHoPhoneScreenState();
}

class _LichTaoHoPhoneScreenState extends State<LichTaoHoPhoneScreen> {
  @override
  void initState() {
    super.initState();
    widget.cubit.getDay();
