...
class CustomSelectXa extends StatefulWidget {
  final String? value;
  ...
  @override
  _CustomSelectXaState createState() => _CustomSelectXaState();
}

class _CustomSelectXaState extends State<CustomSelectXa> {
