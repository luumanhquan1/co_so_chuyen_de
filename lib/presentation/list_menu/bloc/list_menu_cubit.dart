...
class ListMenuCubit extends BaseCubit<ListMenuState> {
  ...
  List<MenuItemSchedule> menuItems = [
    ...
    MenuItemSchedule(
      ...
      badgeNumber: 0,
      children: [
        ChildrenMenuItem(isSelected: true, title: 'Lãnh đạo UBND Tỉnh', number: 12),
        ChildrenMenuItem(isSelected: true, title: 'Văn phòng UBND Tỉnh', number: 3),
        ChildrenMenuItem(isSelected: true, title: 'Sở Kế hoạch và Đầu tư', number: 8)
      ],
    ),
  ];
