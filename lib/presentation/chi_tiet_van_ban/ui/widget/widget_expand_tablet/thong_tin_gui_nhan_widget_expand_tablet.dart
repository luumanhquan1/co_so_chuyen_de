...
class ThongTinGuiNhanWidgetExpandTablet extends StatefulWidget {
   ...
   ThongTinGuiNhanWidgetExpandTablet({Key? key, required this.cubit, required this.expanded}) : super(key: key);

  @override
  State<ThongTinGuiNhanWidgetExpandTablet> createState() => _ThongTinGuiNhanWidgetExpandTabletState();
}

class _ThongTinGuiNhanWidgetExpandTabletState extends State<ThongTinGuiNhanWidgetExpandTablet> {
  @override
