...
class LichSuCapNhatTinhHinhXuLyExpandWidget extends StatelessWidget {
  final DetailDocumentCubit cubit;

  const LichSuCapNhatTinhHinhXuLyExpandWidget({Key? key, required this.cubit}) : super(key: key);
