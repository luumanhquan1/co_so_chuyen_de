...
void loadApi(){
 ...
 void insertItemUsing(WidgetModel widgetItem, List
 <WidgetModel>listItemWidgetUsing,
     List<WidgetModel>listItemWidgetNotUse, int index,){
 ...
 void insertItemNotUse(WidgetModel widgetItem, List
 <WidgetModel>listItemWidgetUsing,
     List<WidgetModel>listItemWidgetNotUse, int index,){
