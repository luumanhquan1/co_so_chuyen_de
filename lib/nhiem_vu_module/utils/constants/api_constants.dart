class ApiConstants {
  ...
  static const GET_LICH_SU_PHAN_XU_LY_NHIEM_VU= '/qlvb/api/qlnv/phan-xu-ly/getbynhiemvu';
  static const GET_Y_KIEN_XU_LY= '/qlvb/api/qlnv/y-kien-xu-ly/{id}?';
  static const GET_DANH_SACH_CONG_VIEC_CHI_TIET_NHIEM_VU= '/qlvb/api/qlnv/cong-viec/dsbynhiemvu';
}
