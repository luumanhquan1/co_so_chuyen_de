class ApiConstants {
  ...
  static const MEETING_ROOM_DANH_SACH_PHONG_HOP = '/vpdt/api/MeetingRoom/danh-sach-phong-hop';
  static const MEETING_ROOM_DANH_SACH_THIET_BI ='/vpdt/api/MeetingRoom/danh-sach-thiet-bi';
